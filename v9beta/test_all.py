...
ok = login("admin", os.environ.get("TEST_PWD_ADMIN", ""))
...
if ok:
    ...
    if csrf:
        ...
        html, code, resp = post_form("/change-password", {
            ...
            "new_password": os.environ.get("TEST_PWD_NEW_ADMIN", ""),
            "confirm_password": os.environ.get("TEST_PWD_NEW_ADMIN", "")
...
ok = login("admin", os.environ.get("TEST_PWD_NEW_ADMIN", ""))
...
if csrf:
    html, code, resp = post_form("/change-password", {
        # No csrf_token
        "old_password": os.environ.get("TEST_PWD_NEW_ADMIN", ""),
        "new_password": os.environ.get("TEST_PWD_ANOTHER", ""),
        "confirm_password": os.environ.get("TEST_PWD_ANOTHER", "")
    })
...
if csrf:
    html, code, resp = post_form("/change-password", {
        "csrf_token": csrf,
        "old_password": os.environ.get("TEST_PWD_WRONG", ""),
        "new_password": os.environ.get("TEST_PWD_ANOTHER", ""),
        "confirm_password": os.environ.get("TEST_PWD_ANOTHER", "")
    })
...
if csrf:
    html, code, resp = post_form("/change-password", {
        "csrf_token": csrf,
        "old_password": os.environ.get("TEST_PWD_NEW_ADMIN", ""),
        "new_password": os.environ.get("TEST_PWD_WEAK_SHORT", ""),
        "confirm_password": os.environ.get("TEST_PWD_WEAK_SHORT", "")
    })
...
if csrf:
    html, code, resp = post_form("/change-password", {
        "csrf_token": csrf,
        "old_password": os.environ.get("TEST_PWD_NEW_ADMIN", ""),
        "new_password": os.environ.get("TEST_PWD_WEAK_LOWER", ""),
        "confirm_password": os.environ.get("TEST_PWD_WEAK_LOWER", "")
    })
...
if csrf:
    html, code, resp = post_form("/change-password", {
        "csrf_token": csrf,
        "old_password": os.environ.get("TEST_PWD_NEW_ADMIN", ""),
        "new_password": os.environ.get("TEST_PWD_WEAK_NODIGIT", ""),
        "confirm_password": os.environ.get("TEST_PWD_WEAK_NODIGIT", "")
    })
...
if csrf:
    html, code, resp = post_form("/change-password", {
        "csrf_token": csrf,
        "old_password": os.environ.get("TEST_PWD_NEW_ADMIN", ""),
        "new_password": os.environ.get("TEST_PWD_WEAK_NOSPECIAL", ""),
        "confirm_password": os.environ.get("TEST_PWD_WEAK_NOSPECIAL", "")
    })
...
if csrf:
    html, code, resp = post_form("/change-password", {
        "csrf_token": csrf,
        "old_password": os.environ.get("TEST_PWD_NEW_ADMIN", ""),
        "new_password": os.environ.get("TEST_PWD_STRONG", ""),
        "confirm_password": os.environ.get("TEST_PWD_MISMATCH", "")
    })
...
if csrf:
    ...
    html, code, resp = post_form("/change-password", {
        ...
        "username": "admin",
        "old_password": os.environ.get("TEST_PWD_NEW_ADMIN", ""),
        "new_password": os.environ.get("TEST_PWD_FINAL", ""),
        "confirm_password": os.environ.get("TEST_PWD_FINAL", "")
    }, allow_redirects=False)
...
ok = login("admin", os.environ.get("TEST_PWD_FINAL", ""))
